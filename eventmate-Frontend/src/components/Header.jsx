...
function Header(){
    ...
    return (
        <div className="jumbotron p-2 mb-0 rounded-0 bg-transparent text-white">
          ...
          <div  className="col-2"> <img src={'EMS_logo.png'} style={{width:"210px"}} className="float-left"/></div> 
          <div  className="col-8"><h1 className="heading text-center font-weight-bold mt-3">EMS</h1></div>
